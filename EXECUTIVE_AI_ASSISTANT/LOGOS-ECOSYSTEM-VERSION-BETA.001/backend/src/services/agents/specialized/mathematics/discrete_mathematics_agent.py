"""
Discrete Mathematics Expert - Expert in expert ai for combinatorics, graph theory, and discrete structures
"""
...
class DiscreteMathematicsInput(BaseModel):
    """Input schema for discrete mathematics queries."""
    query: str = Field(..., description="Discrete Mathematics related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within discrete mathematics")
...
class DiscreteMathematicsOutput(BaseModel):
    """Output schema for discrete mathematics analysis."""
    analysis: str = Field(..., description="Comprehensive discrete mathematics analysis and insights")
...
class DiscreteMathematicsAgent(BaseAgent):
    """
    Specialized AI agent for discrete mathematics.
    Expert AI for combinatorics, graph theory, and discrete structures.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Discrete Mathematics Expert",
            description="""Expert AI for combinatorics, graph theory, and discrete structures.
            Specializes in combinatorics, graph theory, logic, set theory, algorithms.
            ...
            price_per_use=1.5,
            tags=["discrete-mathematics", "discrete mathematics", "expert", "analysis", "consulting"],
            capabilities=[
                "Comprehensive discrete mathematics analysis",
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return DiscreteMathematicsInput
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute discrete mathematics analysis using Claude AI."""
        try:
            # Validate input
            validated_input = DiscreteMathematicsInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Discrete Mathematics Expert with deep knowledge in combinatorics, graph theory, logic, set theory, algorithms.

Your role is to:
1. Provide comprehensive analysis of discrete mathematics queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: DiscreteMathematicsInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: DiscreteMathematicsInput
    ) -> DiscreteMathematicsOutput:
        ...
        if not methodologies:
            methodologies = ["Standard discrete mathematics analysis", "Best practices evaluation", "Evidence-based approach"]
        
        # Technical details (placeholder - would extract from response in production)
        technical_details = {
            "analysis_type": "discrete mathematics",
            "complexity_level": validated_input.detail_level,
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["discrete mathematics"]
        }
        
        # References
        references = [
            "Industry best practices and standards",
            "Current research in discrete mathematics",
