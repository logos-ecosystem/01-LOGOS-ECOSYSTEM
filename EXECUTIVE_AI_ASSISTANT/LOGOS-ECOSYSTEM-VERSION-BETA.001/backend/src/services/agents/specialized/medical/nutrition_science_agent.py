"""
Nutrition Science Expert - Expert in expert ai for nutritional science, dietetics, and metabolic health
"""
...
class NutritionScienceAgentInput(BaseModel):
...
class NutritionScienceAgentOutput(BaseModel):
...
class NutritionScienceAgent(BaseAgent):
    ...
    Expert AI for nutritional science, dietetics, and metabolic health.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Nutrition Science Expert",
            description="""Expert AI for nutritional science, dietetics, and metabolic health.
            Specializes in nutritional biochemistry, dietary planning, metabolic health, clinical nutrition.
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return NutritionScienceAgentInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return NutritionScienceAgentOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute nutrition science analysis using Claude AI."""
        try:
            # Validate input
            validated_input = NutritionScienceAgentInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Nutrition Science Expert with deep knowledge in nutritional biochemistry, dietary planning, metabolic health, clinical nutrition.
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: NutritionScienceAgentInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: NutritionScienceAgentInput
    ) -> NutritionScienceAgentOutput:
