"""
Education Specialist - Expert in expert ai for educational strategies, curriculum design, and learning science
"""
...
class EducationAgentInput(BaseModel):
    """Input schema for education queries."""
    query: str = Field(..., description="Education related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within education")
    detail_level: Optional[str] = Field("comprehensive", description="Level of detail required (basic/intermediate/comprehensive)")


class EducationAgentOutput(BaseModel):
    """Output schema for education analysis."""
    analysis: str = Field(..., description="Comprehensive education analysis and insights")
...
class EducationAgent(BaseAgent):
    """
    Specialized AI agent for education.
    Expert AI for educational strategies, curriculum design, and learning science.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Education Specialist",
            description="""Expert AI for educational strategies, curriculum design, and learning science.
            Specializes in curriculum development, pedagogical methods, educational technology, assessment design.
            ...
            price_per_use=1.5,
            tags=["education", "education", "expert", "analysis", "consulting"],
            capabilities=[
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute education analysis using Claude AI."""
        try:
            # Validate input
            validated_input = EducationAgentInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Education Specialist with deep knowledge in curriculum development, pedagogical methods, educational technology, assessment design.

Your role is to:
1. Provide comprehensive analysis of education queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: EducationAgentInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: EducationAgentInput
        ...
        if not methodologies:
            methodologies = ["Standard education analysis", "Best practices evaluation", "Evidence-based approach"]
        ...
        technical_details = {
            ...
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["education"]
        }
