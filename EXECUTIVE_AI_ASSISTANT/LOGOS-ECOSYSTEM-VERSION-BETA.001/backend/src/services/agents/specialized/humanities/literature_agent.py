"""
Literature Expert - Expert in expert ai for literary analysis, criticism, and literary theory
"""
...
class LiteratureInput(BaseModel):
    """Input schema for literature queries."""
    query: str = Field(..., description="Literature related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within literature")
...
class LiteratureOutput(BaseModel):
    """Output schema for literature analysis."""
    analysis: str = Field(..., description="Comprehensive literature analysis and insights")
...
class LiteratureAgent(BaseAgent):
    """
    Specialized AI agent for literature.
    Expert AI for literary analysis, criticism, and literary theory.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Literature Expert",
            description="""Expert AI for literary analysis, criticism, and literary theory.
            Specializes in literary analysis, literary theory, comparative literature, creative writing, criticism.
            ...
            price_per_use=1.5,
            tags=["literature", "literature", "expert", "analysis", "consulting"],
            capabilities=[
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute literature analysis using Claude AI."""
        try:
            # Validate input
            validated_input = LiteratureInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Literature Expert with deep knowledge in literary analysis, literary theory, comparative literature, creative writing, criticism.

Your role is to:
1. Provide comprehensive analysis of literature queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: LiteratureInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: LiteratureInput
    ) -> LiteratureOutput:
        ...
        if not methodologies:
            methodologies = ["Standard literature analysis", "Best practices evaluation", "Evidence-based approach"]
        ...
        technical_details = {
            ...
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["literature"]
        }
        
        # References
        references = [
            "Industry best practices and standards",
            "Current research in literature",
