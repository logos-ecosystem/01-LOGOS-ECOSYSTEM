"""
Technology Solutions Expert - Expert in expert ai for technology strategy, digital transformation, and tech consulting
"""
...
class TechnologyInput(BaseModel):
    """Input schema for technology queries."""
    query: str = Field(..., description="Technology related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within technology")
...
class TechnologyOutput(BaseModel):
    """Output schema for technology analysis."""
    analysis: str = Field(..., description="Comprehensive technology analysis and insights")
...
class TechnologyAgent(BaseAgent):
    """
    Specialized AI agent for technology.
    Expert AI for technology strategy, digital transformation, and tech consulting.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Technology Solutions Expert",
            description="""Expert AI for technology strategy, digital transformation, and tech consulting.
            Specializes in technology strategy, digital transformation, system architecture, tech trends.
            ...
            price_per_use=2.0,
            tags=["technology", "technology", "expert", "analysis", "consulting"],
            capabilities=[
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute technology analysis using Claude AI."""
        try:
            # Validate input
            validated_input = TechnologyInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Technology Solutions Expert with deep knowledge in technology strategy, digital transformation, system architecture, tech trends.

Your role is to:
1. Provide comprehensive analysis of technology queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: TechnologyInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: TechnologyInput
    ) -> TechnologyOutput:
        ...
        if not methodologies:
            methodologies = ["Standard technology analysis", "Best practices evaluation", "Evidence-based approach"]
        ...
        technical_details = {
            ...
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["technology"]
        }
        
        # References
        references = [
            "Industry best practices and standards",
            "Current research in technology",
