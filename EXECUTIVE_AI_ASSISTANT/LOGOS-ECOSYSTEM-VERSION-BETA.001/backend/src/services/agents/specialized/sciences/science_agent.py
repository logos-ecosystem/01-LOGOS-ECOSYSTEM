"""
General Science Expert - Expert in expert ai for interdisciplinary science, scientific methods, and research
"""
...
class ScienceInput(BaseModel):
    """Input schema for science queries."""
    query: str = Field(..., description="Science related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within science")
...
class ScienceOutput(BaseModel):
    """Output schema for science analysis."""
    analysis: str = Field(..., description="Comprehensive science analysis and insights")
...
class ScienceAgent(BaseAgent):
    """
    Specialized AI agent for science.
    Expert AI for interdisciplinary science, scientific methods, and research.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="General Science Expert",
            description="""Expert AI for interdisciplinary science, scientific methods, and research.
            Specializes in scientific method, research design, interdisciplinary science, data analysis.
            ...
            price_per_use=1.5,
            tags=["science", "science", "expert", "analysis", "consulting"],
            capabilities=[
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute science analysis using Claude AI."""
        try:
            # Validate input
            validated_input = ScienceInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert General Science Expert with deep knowledge in scientific method, research design, interdisciplinary science, data analysis.

Your role is to:
1. Provide comprehensive analysis of science queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: ScienceInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        ...
        if not methodologies:
            methodologies = ["Standard science analysis", "Best practices evaluation", "Evidence-based approach"]
        ...
        technical_details = {
            ...
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["science"]
        }
        
        # References
        references = [
            "Industry best practices and standards",
            "Current research in science",
