...
class GenomicsAgent(BaseAgent):
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        ...
        try:
            # Validate input
            validated_input = GenomicsInput(**input_data.input_data)
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: GenomicsInput) -> str:
