"""
Atmospheric Sciences Specialist - Expert in expert ai for atmospheric dynamics, weather systems, and atmospheric chemistry
"""
...
class AtmosphericSciencesInput(BaseModel):
...
class AtmosphericSciencesOutput(BaseModel):
...
class AtmosphericSciencesAgent(BaseAgent):
    ...
    Expert AI for atmospheric dynamics, weather systems, and atmospheric chemistry.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Atmospheric Sciences Specialist",
            description="""Expert AI for atmospheric dynamics, weather systems, and atmospheric chemistry.
            Specializes in atmospheric dynamics, cloud physics, atmospheric chemistry, weather systems.
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return AtmosphericSciencesInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return AtmosphericSciencesOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute atmospheric sciences analysis using Claude AI."""
        try:
            # Validate input
            validated_input = AtmosphericSciencesInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Atmospheric Sciences Specialist with deep knowledge in atmospheric dynamics, cloud physics, atmospheric chemistry, weather systems.
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: AtmosphericSciencesInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: AtmosphericSciencesInput
    ) -> AtmosphericSciencesOutput:
