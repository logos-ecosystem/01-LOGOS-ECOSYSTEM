"""
Political Science Expert - Expert in expert ai for political systems, governance, and political theory
"""
...
class PoliticalScienceInput(BaseModel):
...
class PoliticalScienceOutput(BaseModel):
...
class PoliticalScienceAgent(BaseAgent):
    ...
    Expert AI for political systems, governance, and political theory.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Political Science Expert",
            description="""Expert AI for political systems, governance, and political theory.
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return PoliticalScienceInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return PoliticalScienceOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute political science analysis using Claude AI."""
        try:
            # Validate input
            validated_input = PoliticalScienceInput(**input_data.input_data)
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: PoliticalScienceInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: PoliticalScienceInput
    ) -> PoliticalScienceOutput:
