"""
Agriculture Expert - Expert in expert ai for agricultural practices, crop science, and sustainable farming
"""
...
class AgricultureAgent(BaseAgent):
    ...
    Expert AI for agricultural practices, crop science, and sustainable farming.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Agriculture Expert",
            description="""Expert AI for agricultural practices, crop science, and sustainable farming.
            Specializes in crop science, soil management, precision agriculture, sustainable farming, agronomy.
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        ...
        try:
            # Validate input
            validated_input = AgricultureInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Agriculture Expert with deep knowledge in crop science, soil management, precision agriculture, sustainable farming, agronomy.
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: AgricultureInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: AgricultureInput
    ) -> AgricultureOutput:
