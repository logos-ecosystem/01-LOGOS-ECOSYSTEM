"""
Neuropharmacology Specialist - Expert in expert ai for drugs affecting the nervous system and neurotransmitter mechanisms
"""
...
class NeuropharmacologyInput(BaseModel):
...
class NeuropharmacologyOutput(BaseModel):
...
class NeuropharmacologyAgent(BaseAgent):
    ...
    Expert AI for drugs affecting the nervous system and neurotransmitter mechanisms.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Neuropharmacology Specialist",
            description="""Expert AI for drugs affecting the nervous system and neurotransmitter mechanisms.
            Specializes in psychopharmacology, drug mechanisms, neurotransmitters, drug interactions, therapeutics.
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return NeuropharmacologyInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return NeuropharmacologyOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute neuropharmacology analysis using Claude AI."""
        try:
            # Validate input
            validated_input = NeuropharmacologyInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Neuropharmacology Specialist with deep knowledge in psychopharmacology, drug mechanisms, neurotransmitters, drug interactions, therapeutics.
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: NeuropharmacologyInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: NeuropharmacologyInput
    ) -> NeuropharmacologyOutput:
