"""
R&D Specialist - Expert in expert ai for research methodologies, innovation management, and r&d strategy
"""
...
class ResearchDevelopmentInput(BaseModel):
    """Input schema for research development queries."""
    query: str = Field(..., description="Research Development related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within research development")
    detail_level: Optional[str] = Field("comprehensive", description="Level of detail required (basic/intermediate/comprehensive)")


class ResearchDevelopmentOutput(BaseModel):
    """Output schema for research development analysis."""
    analysis: str = Field(..., description="Comprehensive research development analysis and insights")
...
class ResearchDevelopmentAgent(BaseAgent):
    """
    Specialized AI agent for research development.
    Expert AI for research methodologies, innovation management, and R&D strategy.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="R&D Specialist",
            description="""Expert AI for research methodologies, innovation management, and R&D strategy.
            Specializes in research methods, innovation management, technology transfer, R&D strategy.
            ...
            price_per_use=2.0,
            tags=["research-development", "research development", "expert", "analysis", "consulting"],
            capabilities=[
                "Comprehensive research development analysis",
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return ResearchDevelopmentInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return ResearchDevelopmentOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute research development analysis using Claude AI."""
        try:
            # Validate input
            validated_input = ResearchDevelopmentInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert R&D Specialist with deep knowledge in research methods, innovation management, technology transfer, R&D strategy.

Your role is to:
1. Provide comprehensive analysis of research development queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: ResearchDevelopmentInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: ResearchDevelopmentInput
    ) -> ResearchDevelopmentOutput:
        ...
        if not methodologies:
            methodologies = ["Standard research development analysis", "Best practices evaluation", "Evidence-based approach"]
        
        # Technical details (placeholder - would extract from response in production)
        technical_details = {
            "analysis_type": "research development",
            "complexity_level": validated_input.detail_level,
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["research development"]
        }
        
        # References
        references = [
            "Industry best practices and standards",
            "Current research in research development",
