"""
DevOps Engineering Expert - Expert in expert ai for ci/cd pipelines, infrastructure as code, and automation
"""
...
class DevopsEngineeringInput(BaseModel):
...
class DevopsEngineeringOutput(BaseModel):
...
class DevopsEngineeringAgent(BaseAgent):
    ...
    Expert AI for CI/CD pipelines, infrastructure as code, and automation.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="DevOps Engineering Expert",
            description="""Expert AI for CI/CD pipelines, infrastructure as code, and automation.
            Specializes in CI/CD, containerization, Kubernetes, monitoring, infrastructure automation.
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return DevopsEngineeringInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return DevopsEngineeringOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute devops engineering analysis using Claude AI."""
        try:
            # Validate input
            validated_input = DevopsEngineeringInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert DevOps Engineering Expert with deep knowledge in CI/CD, containerization, Kubernetes, monitoring, infrastructure automation.
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: DevopsEngineeringInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: DevopsEngineeringInput
    ) -> DevopsEngineeringOutput:
