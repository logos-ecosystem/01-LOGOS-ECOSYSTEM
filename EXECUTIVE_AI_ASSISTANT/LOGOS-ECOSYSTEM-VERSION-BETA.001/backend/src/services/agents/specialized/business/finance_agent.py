"""
Finance Expert - Expert in expert ai for financial analysis, investment strategies, and corporate finance
"""
...
class FinanceInput(BaseModel):
    """Input schema for finance queries."""
    query: str = Field(..., description="Finance related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within finance")
    detail_level: Optional[str] = Field("comprehensive", description="Level of detail required (basic/intermediate/comprehensive)")


class FinanceOutput(BaseModel):
    """Output schema for finance analysis."""
    analysis: str = Field(..., description="Comprehensive finance analysis and insights")
...
class FinanceAgent(BaseAgent):
    """
    Specialized AI agent for finance.
    Expert AI for financial analysis, investment strategies, and corporate finance.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Finance Expert",
            description="""Expert AI for financial analysis, investment strategies, and corporate finance.
            Specializes in financial analysis, investment management, risk assessment, corporate finance.
            ...
            price_per_use=2.0,
            tags=["finance", "finance", "expert", "analysis", "consulting"],
            capabilities=[
    ...
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute finance analysis using Claude AI."""
        try:
            # Validate input
            validated_input = FinanceInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Finance Expert with deep knowledge in financial analysis, investment management, risk assessment, corporate finance.

Your role is to:
1. Provide comprehensive analysis of finance queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: FinanceInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        ...
        if not methodologies:
            methodologies = ["Standard finance analysis", "Best practices evaluation", "Evidence-based approach"]
        ...
        technical_details = {
            ...
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["finance"]
        }
