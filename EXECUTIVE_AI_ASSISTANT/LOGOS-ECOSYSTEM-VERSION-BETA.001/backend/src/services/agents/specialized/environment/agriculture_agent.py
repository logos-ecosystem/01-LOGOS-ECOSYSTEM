"""
Agriculture Specialist - Expert in expert ai for farming, crop management, and sustainable agriculture
"""
...
class AgricultureAgentInput(BaseModel):
    """Input schema for agriculture queries."""
    query: str = Field(..., description="Agriculture related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within agriculture")
    detail_level: Optional[str] = Field("comprehensive", description="Level of detail required (basic/intermediate/comprehensive)")


class AgricultureAgentOutput(BaseModel):
    """Output schema for agriculture analysis."""
    analysis: str = Field(..., description="Comprehensive agriculture analysis and insights")
...
class AgricultureAgent(BaseAgent):
    """
    Specialized AI agent for agriculture.
    Expert AI for farming, crop management, and sustainable agriculture.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Agriculture Specialist",
            description="""Expert AI for farming, crop management, and sustainable agriculture.
            Specializes in crop management, precision farming, soil analysis, pest control, sustainable practices.
            ...
            price_per_use=1.5,
            tags=["agriculture", "agriculture", "expert", "analysis", "consulting"],
            capabilities=[
                "Comprehensive agriculture analysis",
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return AgricultureAgentInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return AgricultureAgentOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute agriculture analysis using Claude AI."""
        try:
            # Validate input
            validated_input = AgricultureAgentInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Agriculture Specialist with deep knowledge in crop management, precision farming, soil analysis, pest control, sustainable practices.

Your role is to:
1. Provide comprehensive analysis of agriculture queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: AgricultureAgentInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: AgricultureAgentInput
    ) -> AgricultureAgentOutput:
        ...
        if not methodologies:
            methodologies = ["Standard agriculture analysis", "Best practices evaluation", "Evidence-based approach"]
        ...
        technical_details = {
            ...
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["agriculture"]
        }
