"""
Quantum Field Theory Specialist - Expert in expert ai for quantum field theory, gauge theories, and advanced quantum mechanics
"""
...
class QuantumFieldTheoryInput(BaseModel):
    """Input schema for quantum field theory queries."""
    query: str = Field(..., description="Quantum Field Theory related question or request")
    ...
    focus_area: Optional[str] = Field(None, description="Specific area of focus within quantum field theory")
    detail_level: Optional[str] = Field("comprehensive", description="Level of detail required (basic/intermediate/comprehensive)")


class QuantumFieldTheoryOutput(BaseModel):
    """Output schema for quantum field theory analysis."""
    analysis: str = Field(..., description="Comprehensive quantum field theory analysis and insights")
...
class QuantumFieldTheoryAgent(BaseAgent):
    """
    Specialized AI agent for quantum field theory.
    Expert AI for quantum field theory, gauge theories, and advanced quantum mechanics.
    """
    
    def __init__(self):
        metadata = AgentMetadata(
            name="Quantum Field Theory Specialist",
            description="""Expert AI for quantum field theory, gauge theories, and advanced quantum mechanics.
            Specializes in QED, QCD, gauge theories, Feynman diagrams, renormalization.
            ...
            price_per_use=2.5,
            tags=["quantum-field-theory", "quantum field theory", "expert", "analysis", "consulting"],
            capabilities=[
                "Comprehensive quantum field theory analysis",
    ...
    def get_input_schema(self) -> Type[BaseModel]:
        ...
        return QuantumFieldTheoryInput
    
    def get_output_schema(self) -> Type[BaseModel]:
        """Get the output schema for this agent."""
        return QuantumFieldTheoryOutput
    
    async def _execute(self, input_data: AgentInput) -> AgentOutput:
        """Execute quantum field theory analysis using Claude AI."""
        try:
            # Validate input
            validated_input = QuantumFieldTheoryInput(**input_data.input_data)
            
            # Create specialized system prompt
            system_prompt = """You are an expert Quantum Field Theory Specialist with deep knowledge in QED, QCD, gauge theories, Feynman diagrams, renormalization.

Your role is to:
1. Provide comprehensive analysis of quantum field theory queries
...
- Clear and well-organized"""
    ...
    async def _build_prompt(self, validated_input: QuantumFieldTheoryInput) -> str:
...
6. References and further resources""")
    ...
    async def _parse_response(
        self, 
        ai_response: str, 
        validated_input: QuantumFieldTheoryInput
    ) -> QuantumFieldTheoryOutput:
        ...
        if not methodologies:
            methodologies = ["Standard quantum field theory analysis", "Best practices evaluation", "Evidence-based approach"]
        
        # Technical details (placeholder - would extract from response in production)
        technical_details = {
            "analysis_type": "quantum field theory",
            "complexity_level": validated_input.detail_level,
            "focus_areas": [validated_input.focus_area] if validated_input.focus_area else ["quantum field theory"]
        }
        
        # References
        references = [
            "Industry best practices and standards",
            "Current research in quantum field theory",
